...
contract WasabiLendStrategy is BaseUpgradeableStrategy {
  ...
  /**
   * @notice Initializes the strategy and verifies compatibility with the Wasabi lending pool.
   * @param _storage Address of the storage contract.
   * @param _underlying Address of the underlying asset.
   * @param _vault Address of the vault.
   * @param _fToken Address of the fToken (Wasabi lending token).
