...
contract BaseSwapStrategyV2 is BaseUpgradeableStrategy {
  ...
  function _enterRewardPool() internal {
    ...
    if (_rewardPoolBalance() > 0) {  //We already have a position. Withdraw from staking, add to position, stake again.
  ...
  */
  ...
  function onNFTHarvest(address /*operator*/, address /*to*/, uint256 /*tokenId*/, uint256 /*grailAmount*/, uint256 /*xGrailAmount*/, uint256 /**/) external pure returns (bool) {return true;}
