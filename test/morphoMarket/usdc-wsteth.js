...
const Strategy = artifacts.require("MorphoMarketStrategyMainnet_USDC_wstETH");

// Developed and tested at blockNumber 38643850

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Market USDC wstETH", function() {
  let accounts;
