...
const Strategy = artifacts.require("IPORLendingStrategyMainnet_NVDA");

// Developed and tested at blockNumber 50510000
//
// NVDAc carries a single byte of code on Base and is executed natively by the node,
...
describe("Base Mainnet IPOR Nvidia Carry Trade", function() {
  let accounts;
  ...
  // external setup
  let underlyingToken = "0xb20000000000000000000078ee7ce2fE4908108C";
  let plasmaVault = "0xFb132f4C6d9DCF4f80483Ea7D96C5A5dccfcFE83";
  let liveTotalAssets = "5079675083";
  ...
  let farmerBalance = "10000000000"; // 100 NVDAc
