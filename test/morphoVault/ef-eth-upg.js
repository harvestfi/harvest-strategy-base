...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_EF_ETH");

// Developed and tested at blockNumber 33281400

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Vault ExtraFi ETH", function() {
  let accounts;
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i % 3 == 0) {
          await extraToken.transfer(strategy.address, new BigNumber(1e18), {from: extraWhale});
