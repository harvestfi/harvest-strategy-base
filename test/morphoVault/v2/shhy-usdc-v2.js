...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_SHHY_USDC_V2");

// Developed and tested at blockNumber 41488000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Vault V2 Steakhouse High Yield Instant", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x8A175AcB05D1F7d8EE29ace0cFB6975DeDe2ae7a",
