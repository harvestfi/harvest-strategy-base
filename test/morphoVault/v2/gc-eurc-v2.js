...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_GC_EURC_V2");

// Developed and tested at blockNumber 41488000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Vault V2 Gauntlet EURC Balanced", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xa176655E3d10d9eD60735575CaA680Cc9A6F9B98";
  let morphoWhale = "0x3304E22DDaa22bCdC5fCa2269b418046aE7b566A";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xbe2a4eC8E63Fbe4143Dd1ff5B900D40dfcd60ef7",
