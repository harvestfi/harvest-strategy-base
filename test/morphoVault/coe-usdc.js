...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_COE_USDC");
const IRewardPrePay = artifacts.require("IRewardPrePay");

// Developed and tested at blockNumber 32890220

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Vault Clearstar OpenEden USDC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x9928EA67d8a617cA3d62b9F0856c03975935A296";
  let rewardPrePay;
