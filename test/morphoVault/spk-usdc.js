...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_SPK_USDC");
const IRewardPrePay = artifacts.require("IRewardPrePay");

// Developed and tested at blockNumber 26367650

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Vault Spark USDC", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xBb73B0d23E883a7E1a4c62a1B7554939dA4503D2",
