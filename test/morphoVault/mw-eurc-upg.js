...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_MW_EURC");

// Developed and tested at blockNumber 33281400

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Vault Moonwell EURC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xF2f5DD0D089729bB582bf8ABA7C75167a0ea23Bc";
  let wellWhale = "0x4942E15F4B3B684EEbB7eE28C922fc634Cc751B1";
  ...
  before(async function() {
    ...
    await impersonates([governance, underlyingWhale, wellWhale, morphoWhale]);
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x74e41f73dffD1a335f9eE904846AC87a8290f97f",
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i % 3 == 0) {
          await wellToken.transfer(strategy.address, new BigNumber(1e20), {from: wellWhale});
