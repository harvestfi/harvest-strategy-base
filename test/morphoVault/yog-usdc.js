...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_YOG_USDC");
const IRewardPrePay = artifacts.require("IRewardPrePay");

// Developed and tested at blockNumber 30518850

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Morpho Vault YOG USDC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x672e52fF08AFB44633aAdff6E6D32406a36659B3";
  let rewardPrePay;
