...
// Developed and tested at blockNumber 7628490

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Moonwell Fold rETH V2", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xe32e3BD2EC560513CaB4757564cA50D13cAF9F7F";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [usdc, weth]},
        {"uniV3": [weth, usdc]},
        {"balancer": [weth, underlying.address]},
      ]
    });
