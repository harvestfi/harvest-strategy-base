...
const Strategy = artifacts.require("MoonwellFoldStrategyV2Mainnet_CBETH");

// Developed and tested at blockNumber 7623750

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Moonwell Fold CBETH V2", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x99946CEFb02249270373f7F2DC0bd9b085d52ae5",
