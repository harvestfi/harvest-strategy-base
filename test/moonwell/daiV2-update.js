...
const Strategy = artifacts.require("MoonwellFoldStrategyV2Mainnet_DAI");

// Developed and tested at blockNumber 12066250

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Moonwell Fold DAI V2", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x7f9088c6d3FB1A6405Bb3025Cf983E22D2c42bd8";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x6a149EBe60f157C64cA731c1D67C2b8c547bf872",
      ...
      "liquidation": [
        // {"uniV3": [usdc, weth]},
        // {"uniV3": [weth, usdc]},
        // {"aerodrome": [weth, underlying.address]},
      ]
    });
