...
const Strategy = artifacts.require("MoonwellFoldStrategyV2Mainnet_WETH");

// Developed and tested at blockNumber 13499800

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Moonwell Fold WETH V2", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xCde6CeD0eD77cd957Da1841fa6aF9f1d7ab18caF";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        // {"aerodrome": [well, weth]},
        {"aerodrome": [well, weth, usdc]},
      ]
    });
    strategy.addRewardToken(well, {from: governance})
