...
const Strategy = artifacts.require("Moonwell2AssetFoldStrategyMainnet_wstETH_ETH");

// Developed and tested at blockNumber 39854300

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Moonwell Fold wstETH-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x9Ae383135Ef1EaD2bab41C1F97640D51AE8f458f";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xc1CBa3fCea344f92D9239c08C0568f6F2F0ee452");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        ...
        {"aeroCL": [weth, underlying.address]},
        {"aeroCL": [underlying.address, weth]},
      ],
    });
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      await depositVault(farmer1, underlying, vault, new BigNumber(0.001e18));
