...
const Strategy = artifacts.require("BaseSwapStrategyV2Mainnet_ETH_DAI");
const IXBSX = artifacts.require("IXToken");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

// Developed and tested at blockNumber 4340800

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet BaseSwap ETH-DAI", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xE72627a8B89321451BBF429306d759c34458Aac2";
  ...
  let dai = "0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x0FeB1490f80B6978002c3E501753562f2F2853B2");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [{"baseswap": [bsx, weth]}, {"baseswap": [weth, usdc]}, {"baseswap": [weth, usdc, dai]}],
      "ULOwner": ulOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(0.6925).times(D18);
        underlyingPrice = new BigNumber(82.1).times(D18);
