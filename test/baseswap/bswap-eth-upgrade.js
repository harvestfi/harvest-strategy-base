...
const Strategy = artifacts.require("BaseSwapStrategyV2Mainnet_BSWAP_ETH");
...
describe("Base Mainnet BaseSwap BSWAP-ETH Upgrade", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x77533f7fa91c6bDC4c757D04B9450a1376576da0";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xE80B4F755417FB4baF4dbd23C029db3F62786523");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      "existingVaultAddress": "0x50c6c553d083232F1994175332Ff5508b81Aeb96",
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(89.80).times(D18);
