...
const Strategy = artifacts.require("BaseSwapStrategyV2Mainnet_CBETH_ETH");
const IXBSX = artifacts.require("IXToken");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

// Developed and tested at blockNumber 4079700

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet BaseSwap CBETH-ETH Upgrade", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x2EfCb6931F8c08d7d67b2498D0680BF81BF78BF8";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x07CFA5Df24fB17486AF0CBf6C910F24253a674D3");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      "existingVaultAddress": "0xAb0a63eE480E02Ad0d9210ffFae0CFC3Ced7c98B",
    ...
    await strategy.setXBSXVault(hodlVault.address, {from: governance});
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(0.628653).times(D18);
        underlyingPrice = new BigNumber(3360.87).times(D18);
