...
const Strategy = artifacts.require("BaseSwapStrategyV2Mainnet_ETH_USDC");
...
describe("Base Mainnet BaseSwap ETH-USDC", function() {
  ...
  // external setup
  let underlyingWhale = "0x425f52B381301f6297154850b336A6598f4f1aeE";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x41d160033C222E6f3722EC97379867324567d883");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x8f61C658c5960962e6D108F0f63133F248F6d721",
      "announceStrategy": true,
      "strategyArtifact": Strategy,
      "strategyArtifactIsUpgradable": true,
      "underlying": underlying,
      "governance": governance,
      "liquidation": [{"baseswap": [bsx, weth]}, {"baseswap": [weth, usdc]}]
    });
