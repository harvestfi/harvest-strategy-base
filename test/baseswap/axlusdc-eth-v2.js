...
const Strategy = artifacts.require("BaseSwapStrategyV2Mainnet_axlUSDC_ETH");
const IXBSX = artifacts.require("IXToken");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

// Developed and tested at blockNumber 4340000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet BaseSwap axlUSDC-ETH", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x6f859aCDDD93a106777Da55c98Fd51f2A504fD7A";
  ...
  let axlusdc = "0xEB466342C4d449BC9f53A865D5Cb90586f405215";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x9A0b05F3cF748A114A4f8351802b3BFfE07100D4");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [{"baseswap": [bsx, weth]}, {"baseswap": [weth, axlusdc]}],
      "ULOwner": ulOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(0.6916).times(D18);
        underlyingPrice = new BigNumber(80487934.54).times(D18);
