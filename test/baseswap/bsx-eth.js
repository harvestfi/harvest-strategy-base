...
const Strategy = artifacts.require("BaseSwapStrategyV2Mainnet_BSX_ETH");

// Developed and tested at blockNumber 3002065

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet BaseSwap BSX-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x54E5a796023E8F62C8b493885A5e9b195562DB7F";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x7fea0384F38EF6Ae79bB12295a9e10C464204F52");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"baseswap": [bsx, weth]}, {"baseswap": [weth, bsx]}]
    });
