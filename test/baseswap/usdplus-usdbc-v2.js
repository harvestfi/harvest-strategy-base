...
const Strategy = artifacts.require("BaseSwapStrategyV2Mainnet_USDPLUS_USDbC");
const IXBSX = artifacts.require("IXToken");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

// Developed and tested at blockNumber 4340600

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet BaseSwap USD+-USDbC", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x78c873c8133ae885664AD788fd9f506a146F208F";
  ...
  let usdplus = "0xB79DD08EA68A908A97220C76d19A6aA9cBDE4376";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x696b4d181Eb58cD4B54a59d2Ce834184Cf7Ac31A");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [{"baseswap": [weth, usdbc, usdplus]}],
      "ULOwner": ulOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(0.6926).times(D18);
        underlyingPrice = new BigNumber(2004151317101.27).times(D18);
