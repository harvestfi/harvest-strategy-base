...
const Strategy = artifacts.require("BaseSwapStrategyV2Mainnet_axlWBTC_USDbC");
const IXBSX = artifacts.require("IXToken");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

// Developed and tested at blockNumber 4302200

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet BaseSwap axlWBTC-USDbC", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xAF1823bACd8EDDA3b815180a61F8741fA4aBc6Dd";
  ...
  let axlwbtc = "0x1a35EE4640b0A3B87705B0A4B45D227Ba60Ca2ad";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x317d373E590795e2c09D73FaD7498FC98c0A692B");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [{"baseswap": [bsx, weth]}, {"baseswap": [weth, usdbc]}, {"baseswap": [weth, usdbc, axlwbtc]}],
      "ULOwner": ulOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(0.7411).times(D18);
        underlyingPrice = new BigNumber(32734480181845.32).times(D18);
