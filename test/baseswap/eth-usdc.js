...
const Strategy = artifacts.require("BaseSwapStrategyMainnet_ETH_USDC");
...
describe("Base Mainnet BaseSwap ETH-USDC", function() {
  ...
  // external setup
  let underlyingWhale = "0x11A70541df802260856087275115f4735849ea1C";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"baseswap": [bswap, weth]}, {"baseswap": [bswap, weth, usdc]}]
    });
