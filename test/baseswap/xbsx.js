...
const Strategy = artifacts.require("NoopStrategyMainnet_xBSX");
const IXBSX = artifacts.require("IXToken");

// Developed and tested at blockNumber 4079080

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet BaseSwap xBSX", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x756904e48C7fAc2e9Ee79af4e5C2F6Ac32d3F3Cd";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xE4750593d1fC8E74b31549212899A72162f315Fa");
  ...
  before(async function() {
    ...
    await xBSX.updateTransferWhitelist(vault.address, true, {from: baseswapGovernance});
    await xBSX.updateTransferWhitelist(underlyingWhale, true, {from: baseswapGovernance});
