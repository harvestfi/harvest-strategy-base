...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_ETH_USDC_V2");

// Developed and tested at blockNumber 25585980

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Aerodrome ETH-USDC-V2", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xBc77F2EbBc44038638cB1333738C40879311B2d3";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xcDAC0d6c6C59727a65F871236188350531885C43");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"aerodrome": [aero, weth]}],
