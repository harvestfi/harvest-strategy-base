...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_wBLT_BMX");

// Developed and tested at blockNumber 22871850

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Aerodrome wBLT-BMX", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x015a0138Ecc957859853908Ad455647BD33e635B";
  let aero = "0x940181a94A35A4569E4529A3CDfB74e38FD98631";
  let usdc = "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913";
  let bmx = "0x548f93779fBC992010C07467cBaf329DD5F059B7";
  let wblt = "0x4E74D4Db6c0726ccded4656d0BCE448876BB4C7A";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x61907C8C3E6ef7eD813aCc2fBbBf8C05ac0F31d5");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"aerodrome": [aero, usdc, bmx]},
        {"aerodrome": [aero, usdc, wblt]}
      ],
