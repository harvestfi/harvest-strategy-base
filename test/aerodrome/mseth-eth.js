...
const Strategy = artifacts.require("AerodromeStableStrategyMainnet_msETH_ETH");

// Developed and tested at blockNumber 18684400

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aerodrome msETH-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x5DeE0C7C36F0ef68da9c215b7b20701d84E4F8a4";
  let aero = "0x940181a94A35A4569E4529A3CDfB74e38FD98631";
  let weth = "0x4200000000000000000000000000000000000006";
  let mseth = "0x7Ba6F01772924a82D9626c126347A28299E98c98";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xDE4FB30cCC2f1210FcE2c8aD66410C586C8D1f9A");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"aerodrome": [aero, weth, mseth]},
      ],
      "aeroSetup": [
        [weth, mseth, true, "0x0000000000000000000000000000000000000000"]
      ],
    });
