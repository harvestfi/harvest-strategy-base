...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_CHAMP_ETH");

// Developed and tested at blockNumber 25945350

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Aerodrome CHAMP-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x81825E0A04637Ba523b999f2BaA53cAD32B270a4";
  let aero = "0x940181a94A35A4569E4529A3CDfB74e38FD98631";
  let weth = "0x4200000000000000000000000000000000000006";
  let champ = "0xEb6d78148F001F3aA2f588997c5E102E489Ad341";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x26029Ed89A19B919b5698F10cf776a4f4AEA1529");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"aerodrome": [aero, weth, champ]}],
