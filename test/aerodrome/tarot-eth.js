...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_TAROT_ETH");

// Developed and tested at blockNumber 3357100

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aerodrome TAROT-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xB8B281E556c478583087Ae5af5356B485B83E819";
  let aero = "0x940181a94A35A4569E4529A3CDfB74e38FD98631";
  let weth = "0x4200000000000000000000000000000000000006";
  let tarot = "0xF544251D25f3d243A36B07e7E7962a678f952691";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2d25E0514f23c6367687dE89Bd5167dc754D4934");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"aerodrome": [aero, weth]},
        {"aerodrome": [tarot, weth]},
        {"aerodrome": [weth, tarot]},
      ]
    });
