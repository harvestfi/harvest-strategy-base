...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_wUSDR_USDC");

// Developed and tested at blockNumber 3357100

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aerodrome wUSDR-USDC", function() {
  let accounts;
  ...
  let wusdr = "0x9483ab65847A447e36d21af1CaB8C87e9712ff93";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x3Fc28BFac25fC8e93B5b2fc15EfBBD5a8aA44eFe");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"aerodrome": [aero, usdc]},
        {"aerodrome": [wusdr, usdc]},
        {"aerodrome": [usdc, wusdr]},
      ]
    });
