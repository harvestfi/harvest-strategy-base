...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_SEAM_USDbC");

// Developed and tested at blockNumber 12341380

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aerodrome SEAM-USDbC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x42e8dC1b1891C103291Ec01D903451E729DaAACc");
