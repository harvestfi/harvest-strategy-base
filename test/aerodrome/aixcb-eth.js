...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_aixCB_ETH");

// Developed and tested at blockNumber 25945350

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Aerodrome aixCB-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xCADA5a36EEA0bE9bF125D6FF1f713Ad5e1B2d665";
  let aero = "0x940181a94A35A4569E4529A3CDfB74e38FD98631";
  let weth = "0x4200000000000000000000000000000000000006";
  let aixcb = "0x76C71F1703Fbf19FFdcF3051E1e684Cb9934510f";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x19C3c7EEfb070EE00ddE367A9768De1DF52cbE5d");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"aerodrome": [aero, weth, aixcb]}],
