...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_VVV_ETH");

// Developed and tested at blockNumber 25945350

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Aerodrome VVV-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x73831e7c600F48cebBbfF957b466be8e5c087F34";
  let aero = "0x940181a94A35A4569E4529A3CDfB74e38FD98631";
  let weth = "0x4200000000000000000000000000000000000006";
  let vvv = "0xacfE6019Ed1A7Dc6f7B508C02d1b04ec88cC21bf";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x01784ef301D79e4B2DF3a21ad9a536d4cF09A5Ce");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"aerodrome": [aero, weth, vvv]}],
