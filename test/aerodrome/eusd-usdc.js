...
const Strategy = artifacts.require("AerodromeStableStrategyMainnet_eUSD_USDC");

// Developed and tested at blockNumber 18684400

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aerodrome eUSD-USDC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x7A034374C89C463DD65D8C9BCfe63BcBCED41f4F");
