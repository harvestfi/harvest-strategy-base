...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_cbBTC_ETH");

// Developed and tested at blockNumber 19981700

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aerodrome cbBTC-ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xe289E33d5F518b8f239DA16436d14529e2B87267";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2578365B3dfA7FfE60108e181EFb79FeDdec2319");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"aerodrome": [aero, weth, cbbtc]}]
    });
