...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_fBOMB_ETH");

// Developed and tested at blockNumber 3359260
...
describe("Arbitrum Mainnet Aerodrome cbETH-ETH", function() {
  ...
  // external setup
  let underlyingWhale = "0xab1bD7cC8616515929c34256afe543B35b800B71";
  let aero = "0x940181a94A35A4569E4529A3CDfB74e38FD98631";
  let weth = "0x4200000000000000000000000000000000000006";
  let fbomb = "0x74ccbe53F77b08632ce0CB91D3A545bF6B8E0979";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x4F9Dc2229f2357B27C22db56cB39582c854Ad6d5");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"aerodrome": [aero, weth]},
        {"aerodrome": [fbomb, weth]},
        {"aerodrome": [weth, fbomb]},
      ]
    });
