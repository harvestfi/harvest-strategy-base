...
const Strategy = artifacts.require("AerodromeStableStrategyMainnet_USDC_USDbC");

// Developed and tested at blockNumber 12331740

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aerodrome USDC-USDbC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x27a8Afa3Bd49406e48a074350fB7b2020c43B2bD");
