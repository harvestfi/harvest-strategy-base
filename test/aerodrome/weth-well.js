...
const Strategy = artifacts.require("AerodromeVolatileStrategyMainnet_WETH_WELL");

// Developed and tested at blockNumber 12336950

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aerodrome WETH_WELL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x45cF34ef1716936E3fD420e3D927efbd78a9B1BB";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xffA3F8737C39e36dec4300B162c2153c67c8352f");
