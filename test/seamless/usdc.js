...
const Strategy = artifacts.require("SeamlessFoldStrategyMainnet_USDC");

// Developed and tested at blockNumber 9655500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Seamless Fold USDC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xBEb522ec6b172D2bab0AEa575C76f4716ED58F15";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        ...
        {"uniV3": [usdbc, weth]},
        {"uniV3": [usdbc, underlying.address]},
      ]
    });
