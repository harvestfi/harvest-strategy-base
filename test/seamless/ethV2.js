...
const Strategy = artifacts.require("SeamlessFoldStrategyV2Mainnet_ETH");

// Developed and tested at blockNumber 10563600

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Seamless Fold ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x90d0607896ABB28a0985c2c2Cd2386c945d06b36";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x21B27a241E361F6C4d430FD120B2651A89DCc942",
