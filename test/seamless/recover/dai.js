...
const Strategy = artifacts.require("SeamlessRecoveryMainnet_DAI");

// Developed and tested at blockNumber 11821280

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Seamless Recovery DAI", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x79fB4E7AD856bEd1030ECE63a6F9813e2a3dD7fe";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xE82E813339EEE960Aa4d87d43241cc27Db9dd916",
