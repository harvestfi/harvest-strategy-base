...
const Strategy = artifacts.require("SeamlessRecoveryMainnet_wstETH");

// Developed and tested at blockNumber 11821280

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Seamless Recovery wstETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xAA1dB2F567D0B9955b1Da90bA787Ad251FdB67ff";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x94012F721e059748B986394EB5fE2820025F47Ff",
