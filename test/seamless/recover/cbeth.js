...
const Strategy = artifacts.require("SeamlessRecoveryMainnet_cbETH");

// Developed and tested at blockNumber 11821280

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Seamless Recovery cbETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x0C85Ac02958AA3Fd8E7146FA81ceAc45b7E0B782";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xC62e0378bb3736bcC148B9A25b1e2ACF523B5f00",
