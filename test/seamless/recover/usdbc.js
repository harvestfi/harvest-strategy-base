...
const Strategy = artifacts.require("SeamlessRecoveryMainnet_USDbC");

// Developed and tested at blockNumber 11821280

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Seamless Recovery USDbC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x21da3e9e36AE59d5c32b93f36207DAe10784CF45";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xA066b2126f25C0237c0DdB293DB452597B1E0241",
