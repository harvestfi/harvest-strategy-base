...
const Strategy = artifacts.require("SeamlessFoldStrategyMainnet_cbETH");

// Developed and tested at blockNumber 10136580

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Seamless Fold cbETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xe098053877999FA0187357Ac71D3629A7e07e4fE";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2Ae3F1Ec7F1F5012CFEab0185bfc7aa3cf0DEc22");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [usdbc, weth, underlying.address]},
      ]
    });
