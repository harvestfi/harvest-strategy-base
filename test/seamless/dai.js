...
const Strategy = artifacts.require("SeamlessFoldStrategyMainnet_DAI");

// Developed and tested at blockNumber 9655500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Seamless Fold DAI", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x961437cA64d696ff05bac2512e61d6C8B9C592F6";
  let seam = "0x1C7a460413dD4e964f96D8dFC56E7223cE88CD85";
  let usdbc = "0xd9aAEc86B65D86f6A7B5B1b0c42FFA531710b6CA";
  let weth = "0x4200000000000000000000000000000000000006";
  let farm = "0xD08a2917653d4E460893203471f0000826fb4034";
  let ifarm = "0xE7798f023fC62146e8Aa1b36Da45fb70855a77Ea";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        ...
        {"aerodrome": [seam, usdbc, underlying.address]},
        {"uniV3": [usdbc, weth, farm, ifarm]},
        {"uniV3": [usdbc, weth]},
      ]
    });
