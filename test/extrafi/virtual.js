...
const Strategy = artifacts.require("ExtraFiLendStrategyMainnet_VIRTUAL");

// Developed and tested at blockNumber 22580710

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet ExtraFi Lend VIRTUAL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xBD283f39c69Ddc92B61c7Bc8087F8cD9220D09d0";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        ...
        {"aerodrome": [underlying.address, weth]},
      ],
