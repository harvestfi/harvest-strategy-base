...
const Strategy = artifacts.require("ExtraFiLendStrategyMainnet_USDplus");

// Developed and tested at blockNumber 19374750

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet ExtraFi Lend USD+", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x8a46Aa30D1673067AaE6863F02152646E995D832";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xB79DD08EA68A908A97220C76d19A6aA9cBDE4376");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        ...
        {"aerodrome": [extra, weth, usdc, underlying.address]},
        {"aerodrome": [underlying.address, usdc, weth]},
      ],
    });
