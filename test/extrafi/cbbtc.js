...
const Strategy = artifacts.require("ExtraFiLendStrategyMainnet_cbBTC");

// Developed and tested at blockNumber 22576960

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet ExtraFi Lend cbBTC", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        ...
        {"aerodrome": [usdc, underlying.address]},
