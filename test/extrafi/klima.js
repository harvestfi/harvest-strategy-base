...
const Strategy = artifacts.require("ExtraFiLendStrategyMainnet_KLIMA");

// Developed and tested at blockNumber 19374750

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet ExtraFi Lend KLIMA", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xCf9d60c56c337Cb635e4a33E9BC4Ad920A496C67";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xDCEFd8C8fCc492630B943ABcaB3429F12Ea9Fea2");
