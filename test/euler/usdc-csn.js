...
const Strategy = artifacts.require("EulerLendStrategyMainnet_USDC_CSN");

// Developed and tested at blockNumber 50479152

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Euler Lend USDC Clearstar Noon", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x533FEcdFF01c19B33659650FC2a04d703cB35B09";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      await depositVault(farmer1, underlying, vault, 1e6);
