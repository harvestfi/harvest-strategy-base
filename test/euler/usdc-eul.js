...
const Strategy = artifacts.require("EulerLendStrategyMainnet_USDC_EUL");

// Developed and tested at blockNumber 35661600

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Base Mainnet Euler Lend USDC Euler", function() {
  let accounts;
