...
const Strategy = artifacts.require("BalancerStrategyMainnet_axlUSD_USDC");

// Developed and tested at blockNumber 3002860

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Balancer axlUSD-USDC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x6D6239f3e39FbA103480a2926477330AE02C0E60";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xE58cA65f418D4121d6C70d4C133E60cf6fDa363C");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"balancer": [usdc, underlying.address]}]
    });
