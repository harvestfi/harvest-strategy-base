...
const Strategy = artifacts.require("BalancerStrategyMainnet_cbETH_WETH");

// Developed and tested at blockNumber 3002500
...
describe("Arbitrum Mainnet Balancer DAI-USDC", function() {
  ...
  // external setup
  let underlyingWhale = "0x9e5A57470A2a136a3d4De39e1996E05944C4b1fb";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xFb4C2E6E6e27B5b4a07a36360C89EDE29bB3c9B6");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"balancer": [weth, underlying.address]}]
    });
