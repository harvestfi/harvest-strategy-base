...
const Strategy = artifacts.require("BalancerStrategyMainnet_DAI_USDC");

// Developed and tested at blockNumber 2185300

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Balancer DAI-USDC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x9d17Bb55b57b31329CF01aa7017948e398B277bc";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6FbFcf88DB1aADA31F34215b2a1Df7fafb4883e9");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"balancer": [usdc, underlying.address, weth]}, {"balancer": [usdc, underlying.address]}]
    });
